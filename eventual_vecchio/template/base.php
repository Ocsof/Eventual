...
<body> 
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">  <!-- colore nav e nav fissato in alto -->
        <div class="container">  <!-- per rendere centrato il nav-->
            <a class="navbar-brand" href="index2.php">Eventual</a>
            ...
            <div class="collapse navbar-collapse navbar-toggler-right" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                      <a class="nav-link text-center text-white" href="index.php">Benvenuto</a>   
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link text-center text-white home" href="index2.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-center text-white" href="#">Archivio</a>
                    </li>
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                          ...
                          <a class="nav-link dropdown-item text-white" href="signup.php">Sign Up</a>
                      </div>
                    </li>                  
                  <!---
                  <li class="nav-item">
