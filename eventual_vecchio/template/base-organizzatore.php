        ...
        <div class="container">  <!-- per rendere centrato il nav-->
            ...
            <div class="collapse navbar-collapse navbar-toggler-right" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item ">
                        <a class="nav-link text-center text-white home" href="home-promoter.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-center text-white" href="gestione-eventi.php">Archivio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-center text-white" href="gestione.php">Gestione</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                          <a class="nav-link dropdown-item text-white" href="home-promoter.php">Il mio profilo</a>
