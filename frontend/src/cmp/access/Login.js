                        ...
                        <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                            <form>
                                <div
                                    ...
                                    <a href="https://www.facebook.com" type="button" className="btn btn-primary btn-floating mx-1">
                                        <i className="fab fa-facebook-f"></i>
                                    </a>

                                    <a href="https://www.twitter.com" type="button" className="btn btn-primary btn-floating mx-1">
                                        <i className="fab fa-twitter"></i>
                                    </a>

                                    <a href="https://www.linkedin.com" type="button" className="btn btn-primary btn-floating mx-1">
                                        <i className="fab fa-linkedin-in"></i>
                                    </a>
                                    <a href="https://www.google.com" type="button" className="btn btn-primary btn-floating mx-1">
